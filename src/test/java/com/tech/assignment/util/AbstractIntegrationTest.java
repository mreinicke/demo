package com.tech.assignment.util;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import com.tech.assignment.application.BootApplication;
...
public abstract class AbstractIntegrationTest
{
     ...
     * @return
     */
    protected <T> T postEntityWithHeaders(final String requestMappingUrl, final Class<T> serviceReturnTypeClass, final Object objectToPost, HttpHeaders headers) {
        final TestRestTemplate restTemplate = new TestRestTemplate();
        final ObjectMapper mapper = new ObjectMapper();
        try {
